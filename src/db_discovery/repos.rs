...
///
/// Preserves the original casing and dots (e.g. "HUSQ.Aprimo" stays "HUSQ.Aprimo")
...
mod tests {
    ...
    fn test_sanitize_alias() {
        ...
        assert_eq!(sanitize_alias("HUSQ.Aprimo"), "HUSQ.Aprimo");
        assert_eq!(sanitize_alias("KRKA.Aprimo"), "KRKA.Aprimo");
